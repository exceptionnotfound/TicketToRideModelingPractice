...
namespace TicketToRideModelingPractice.Europe.Extensions
{
    public static class CardExtensions
    {
        ...
        public static void Add(this List<DestinationCard> cards, City origin, City destination, int points)
        {
            cards.Add(new DestinationCard(origin, destination, points));
        }
    }
}
